...
namespace ITGBrands.CSFT.Services
{
    ...
    {
        void Initialize();
     Task<(List<SaratogaTags> SaratogaResponses, List<DumperTags> DumperResponses)> StartContainerScan(string selectedTag);

       

    }

    public class WindowsRFIDService : IRFIDService
    {
        ...
        public async Task<(List<SaratogaTags> SaratogaResponses, List<DumperTags> DumperResponses)> StartContainerScan(string selectedTag)
        {
            ...
            var containerresponse = new List<SaratogaTags>();
        ...
        public SaratogaTags ParseSaratogaTag(string dataString, string taglayoutID)
        {
