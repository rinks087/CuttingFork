...
{
    public class ReaderModel : Java.Lang.Object, Readers.IRFIDReaderEventHandler
    {
        ...
        public ReaderModel()
        {
            ...
            {
                // Log or handle the null case to debug the issue
                Console.WriteLine("Error: Current activity is not MainActivity or is null.");
                // Optional: throw a custom exception or handle accordingly
            }
        }
